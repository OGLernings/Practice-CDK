...
export class lambdaStack extends cdk.Stack {
  constructor(
    ...
    const cdkIamRole = new iam.Role(this, "cdkIamLogicalId", {
      ...
      roleName:  "NewIamRoleForLambda1607",
    });
    ...
    const getGcLambda = new lambda.Function(this, "getGcLambdaLogicalId", {
      ...
      code: lambda.Code.fromAsset(path.join(__dirname, "services/UserInfo_SN")),
      ...
      functionName: "newGetinfoCreateIncidentLambda1607",
    });
    ...
    //   integrationArn:'arn:aws:lambda:us-east-1:862165548342:function:' + "cdkGetinfoCreateIncidentLambda040724",
